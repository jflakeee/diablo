...
| 동료 장비 | 무기·방어구 장착, 전투 능력치 반영, 파손 제외, 저장·복원 | `[SYSTEM]` 동료 슬롯/스케일링 검사, `[SAVE] checks=12` | PASS |
...
| 저장 | 원자 교체, 왕복, v1→v7 이관, 퀘스트·웨이포인트·동료 장비·스태미나·시체 상태, 손상 거부·백업 복구·중단 격리 | `[SAVE] checks=12` | PASS |
